...
return (
  ...
  <Card className={classes.root}>
    <CardActionArea style={{height:200}} >
     ...
     {user && user.isAdmin? <Link to="/services"><button style={{marginLeft:8,width:23,height:30,marginTop:4}} onClick={()=>{{dispatch(deleteCategory(category._id))};dispatch(getCategories())}}>  
