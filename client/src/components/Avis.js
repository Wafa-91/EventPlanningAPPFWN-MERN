        ...
        <div className="carousel">
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
              Merci d'avoir rendu notre mariage parfait ... <br />
              -Mehdi & Myriam-
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Un anniversaire en or, je recommande à 100%!
            <br />
              -Rim-
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
              ...
              Vous avez organisé un mariage encore plus beau que dans nos rêves <br/>
              -Rami & Yassmine-
              {" "}
          ...
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Merci d'avoir rendu mon petit ange si heureux à son anniversaire <br/>
            -Siwar-
          ...
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Travailler avec vous a été la meilleure décision que nous ayons jamais prise
              <br />
           -Yassine & Sarra-
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
              Un grand merci, nous la recommanderions vivement à tout le monde <br/>
              -Tarek & Nada-
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Nous n'aurions pas pu le faire sans vous. Elle était incroyable.<br/>
            -Ones-
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Merci Bel Event d'avoir fait partie de notre histoire <br/>
            -Mohamed & Miral 
            </span>
          </div>
          <div className="carousel__face">
            <span className="spann" style={{ marginTop: 103, fontSize: 9 }}>
            Merci à toute l'équipe Vous étiez tous si merveilleux <br/>
            -Jouna-
            </span>
          </div>
        </div>
      ...
      <section style={{ marginTop: 400, width: 1280, marginLeft: 58, }}>
        <div className="container">
          <div className="row">
            ...
            { aviss.map(el=><div className="comment mt-4 text-justify float-left" style={{width:639,height:150, marginRight:20,backgroundColor:"rgb(182, 80, 80)", border:"none"}}>
                {" "}
              ...
              <form className="form2" id="algin-form" style={{backgroundColor:"rgb(182, 80, 80)", border:"none"}}>
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    style={{backgroundColor:"rgb(245 218 218)", border:"none"}}
                  />
                </div>
