import { GET_RESERVATION_LOAD, GET_RESERVATION_SUCCESS, GET_RESERVATION_FAIL,POST_RESERVATION_FAIL, DELETE_RESERVATION, GET_RESERVATION,POST_RESERVATION } from "../constants/reservation"
...
export const deleteReservation=(id)=>async(dispatch)=>{
  let result=await  axios.delete(`/reservation/${id}`)
